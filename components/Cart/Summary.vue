<template>
    <div class="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
        ...
        <Button @click="onCheckout" type="button" :disabled="!cartItem.length" class="w-full mt-6">Checkout</Button>
    </div>
</template>
